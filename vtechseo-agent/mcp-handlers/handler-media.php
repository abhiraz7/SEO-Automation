...
class VTSEO_Media {
    ...
    public static function upload( array $p ): array {
        ...
        VTSEO_Logger::log( 'info', "Uploaded media #{$attach_id}" );
        return [
            'media_id' => $attach_id,
    ...
    public static function delete_media( array $p ): array {
        ...
        VTSEO_Logger::log( 'warn', "Deleted media #{$id}" );
    ...
    public static function update_meta( array $p ): array {
        ...
        VTSEO_Logger::log( 'info', "Updated media meta #{$id}" );
    ...
    public static function update_alt_by_url( array $p ): array {
        ...
        VTSEO_Logger::log( 'info', "Updated alt text for media #{$id} via URL lookup ({$url})" );
